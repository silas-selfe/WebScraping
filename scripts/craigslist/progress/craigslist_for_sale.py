...
cincy_sale = pd.DataFrame({'posted': post_timing,
...
cincy_sale = cincy_sale.drop_duplicates(subset='URL')
len(cincy_sale.drop_duplicates(subset='URL'))
...
cincy_sale['price'] = cincy_sale['price'].fillna(0)
cincy_sale.to_csv('C:/Users/Silas/Documents/ZenithAnalytica/Industries/WebScraping/data/cincyForSale5.csv')